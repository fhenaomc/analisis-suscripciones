...
- A customer is considered **churned** if cancel_date_time **IS NOT NULL**.
- Customers with a **null** cancel_date_time are considered **active** at the end of the observation period.
